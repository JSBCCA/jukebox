songlist = [["Main Theme", "mario_theme", "Super Mario Bros."],
            ...
            ["Final Battle", "shroob", "M&L: Partners in Time"],
            ["Grand Finale", "grand", "M&L: Bowser\'s Inside Story"],
            ["Adventure\'s End", "end", "M&L: Dream Team"],
            ["Final Boss Phase 2", "doublebowser", "M&L: Paper Jam"],
            ["Rogueport", "rogueport", "Paper Mario: TTYD"],
            ["Battle Theme", "ttydbattle", "Paper Mario: TTYD"],
            ["Macho Grubba Battle", "grubba", "Paper Mario: TTYD"],
            ["Sadness and Happiness", "sad_happy_ttyd", "Paper Mario: TTYD"],
            ["Excess Express at Dusk", "at_dusk", "Paper Mario: TTYD"],
            ["Excess Express at Night", "at_night", "Paper Mario: TTYD"],
            ["X-Naut Fortress", "xnaut", "Paper Mario: TTYD"],
            ...
            ["Hyrule Castle (Outside w/ enemies)", "botw_castle", "Zelda: Breath of the Wild"],
            ["The Divine Trial (Final Battle)", "botw_divine", "Zelda: Breath of the Wild"],
            ...
            ["Hollow Bastion", "rcom_hollow_bastion", "Kingdom Hearts Re:CoM"],
            ...
            ["Hammerhead - The Last Bastion", "last_bastion", "Final Fantasy X"],
            ...
            ["Follow in Flight", "flight", "Halo 2: Anniversary"],
            ["Breaking the Covenant", "covenant", "Halo 2: Anniversary"],
